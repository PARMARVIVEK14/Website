                            ...
                            <form>
                                <fieldset class="input">
                                    <p id="login-form-username">
                                        <label for="modlgn_username">First Name</label><br>

                                        <input type="text" name="firstname" required="true" class="inputbox"
                                            value="<?php  echo $row['FirstName'];?>">
                                    </p>

                                    <p id="login-form-username">
                                        <label for="modlgn_username">Last Name</label><br>

                                        <input type="text" name="lastname" required="true" class="inputbox"
                                            value="<?php  echo $row['LastName'];?>">
                                    </p>
                                    <p id="login-form-username">
                                        <label for="modlgn_username">Company Name</label><br>

                                        <input type="text" name="comname" required="true" class="inputbox"
                                            value="<?php  echo $row['CompanyName'];?>">
                                    </p>
                                    <p id="login-form-username">
                                        <label for="modlgn_username">Address</label><br>

                                        <input type="text" name="address" required="true" class="inputbox"
                                    ...
                                    <p id="login-form-username">
                                        ...
                                        <select id="country" name="country" required>
                                            ...
                                            <option value="Congo, Democractic Republic">Congo, Democractic Republic
                                            </option>
                                    ...
                                    <p id="login-form-username">
                                        <label for="modlgn_username">City</label><br>

                                        <input type="text" name="city" required="true" class="inputbox"
                                    ...
                                    <p id="login-form-password">
                                        <label for="modlgn_passwd">Mobile Number</label><br>
                                    ...
                                    <div class="remember">
                                        ...
                                        <input type="submit" name="submit" class="button" value="Save Change">
                                        <div class="clear"></div>
                                    </div>
