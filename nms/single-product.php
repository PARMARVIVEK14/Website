...
<body>
    ...
    <div class="mens">
        <div class="main">
            <div class="wrap">
                <ul class="breadcrumb breadcrumb__t"><a class="home" href="index.php">Home</a> / Single Product Details
                </ul>
                <?php
$pid=$_GET['pid'];
                ...
                <div class="cont span_2_of_3">
                    <div class="grid images_3_of_2">
                        <ul id="etalage">
                            <li>
                                <a href="optionallink.html">
                                    <img class="etalage_thumb_image"
                                        src="admin/productimages/<?php echo $row['productImage1'];?>"
                            ...
                            <li>
                                <img class="etalage_thumb_image"
                                    src="admin/productimages/<?php echo $row['productImage2'];?>"
                                    class="img-responsive" />
                                <img class="etalage_source_image"
                                    src="admin/productimages/<?php echo $row['productImage2'];?>" class="img-responsive"
                                    title="" />
                            </li>
                            <li>
                                <img class="etalage_thumb_image"
                                    src="admin/productimages/<?php echo $row['productImage3'];?>"
                                    class="img-responsive" />
                                <img class="etalage_source_image"
                                    src="admin/productimages/<?php echo $row['productImage3'];?>"
                                    class="img-responsive" />
