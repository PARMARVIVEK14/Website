...
<body>
    ...
    <div id="fwslider">
        ...
        <div class="slidePrev"><span><i class="fa-solid fa-less-than fa-2xl" style="color: #d5dbe1;"></i></span></div>
        <div class="slideNext"><span><i class="fa-solid fa-greater-than fa-2xl" style="color: #d5dbe1;"></i></span>
        </div>
    </div>
...
<<div class="container">
    <div class="slide-container">
        <div class="card-wrapper">
            <?php
            // Define your categories with 'image' and 'name'
            $categories = [['id' => 1, 'name' => 'Plants', 'image' => './images/indoor-plant.png'],
                ['id' => 2, 'name' => 'Flowers', 'image' => './images/flower.png'],
                ['id' => 3, 'name' => 'Seeds', 'image' => './images/sunflower-seeds.jpeg'],
                ['id' => 5, 'name' => 'Cactus', 'image' => './images/cactus.jpg'],
                // Add more categories as needed
            ];

            // Example connection (ensure your database connection details are correct)
            $con = mysqli_connect('localhost', 'root', '', 'nmsdb');

            // Iterate over categories to generate each card
            foreach ($categories as $category) {
                // Sanitize ID if necessary
                // $sanitized_id = mysqli_real_escape_string($con, $category['id']);
                
                // Generate URL encoded name for use in URLs
                $url_encoded_name = urlencode($category['name']);
                ?>

                <div class="card">
                    <div class="image-box">
                        <img src="<?php echo $category['image']; ?>" alt="<?php echo $category['name']; ?>">
                        <a href="products.php?cid=<?php echo $category['id']; ?>&catname=<?php echo $url_encoded_name; ?>">
...
$ret=mysqli_query($con,"select * from tblproducts  order by  ID desc limit 100");
$cnt=1;
